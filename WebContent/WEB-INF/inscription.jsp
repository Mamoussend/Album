...
<p>S'inscrire c'est facile et rapide</p>
  <form method="post" action="#">
     ...
     <input id="prenom" placeholder="prenom" name="prenom" type="text">
     <input id="mail" placeholder="mail" name="mail" type="text">
     <input  id="datnais" placeholder="date de naissance" name="datenais" type="date">
