...
<p>Ajouter un nouveau admin</p>
  <form method="post" action="#">
       <input  id="type" placeholder="type" name="type"   value="admin" type="text" readonly>
     ...
     <input  id="datnais" placeholder="date de naissance" name="datenais"   value="${   user.date_naiss} "type="date">
